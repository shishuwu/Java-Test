/*
 * @(#)GraphSearch.java 1.0 Dec 22, 2015
 *
 */
package com.jasons.datastruct.graph.simple;
 ...
 * 
 * 
 * @author Jason Shi 3:26:49 PM
 * @since
 */
public class GraphSearch {

    /*
     * 深度排序的方法 这个方法的方式：按一个节点，一直深入的找下去，直到它没有节点为止 cur 当前的元素 visited 访问过的元素的集合
     */
    ...
    /**
     * 广度排序的方法 这个方法的方式：按层次对图进行访问，先第一层，再第二层，依次类推
     * 
     * @param start
     *            从哪个开始广度排序
     */
